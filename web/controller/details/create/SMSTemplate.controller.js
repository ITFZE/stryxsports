...
], function(SMSTemplateSAL, MessageToast, Dialog, Text, Button, JSONModel) {
	"use strict";
	return SMSTemplateSAL.extend("com.ss.app.StryxSports.controller.details.create.SMSTemplate", {
		...
		onAfterRendering: function() {
			var that = this;
			that.getView().byId("smsTemplateview").setVisible(false);
